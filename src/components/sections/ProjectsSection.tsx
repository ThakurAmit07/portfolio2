          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
            ...
            >
              ...
              <div className="h-64 sm:h-80 w-full bg-gradient-to-br from-[#1A1028] via-[#0A0A12] to-[#12121C] relative flex flex-col justify-between p-6 overflow-hidden group-hover:scale-[1.01] transition-transform duration-500">
                ...
                <div className="absolute inset-0 bg-[#0A0A12]/85 backdrop-blur-sm opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-center justify-center gap-2">
                  <span className="text-sm font-bold text-white font-display">Open Live Dashboard</span>
        ...
        {selectedProject && (
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4 sm:p-6 overflow-y-auto">
            ...
            <motion.div
              ...
              className="relative w-full max-w-3xl glass-panel-volcanic rounded-3xl p-6 sm:p-8 border border-[#FF5500]/40 shadow-2xl z-10 overflow-hidden my-8"
            >
              <button
                onClick={() => setSelectedProject(null)}
                ...
                <div className="mt-6 pt-4 border-t border-white/10">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 text-xs text-zinc-200">
                    {selectedProject.features.map((feat) => (
                      <div key={feat} className="flex items-start gap-2 bg-white/5 p-2.5 rounded-lg border border-white/5">
                ...
                <div className="flex items-center gap-3">
                  {selectedProject.liveUrl && (
                    <a
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      className="px-5 py-2.5 text-xs font-bold text-white bg-[#FF5500] hover:bg-[#E64D00] rounded-full flex items-center gap-2 shadow-lg shadow-[#FF5500]/30"
                    >
                  ...
                  {selectedProject.githubUrl && (
                    <a
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      className="px-5 py-2.5 text-xs font-bold text-zinc-200 bg-white/10 hover:bg-white/20 border border-white/10 rounded-full flex items-center gap-2"
                    >
                      <GithubIcon className="w-4 h-4" />
