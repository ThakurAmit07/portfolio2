      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-stretch">
          ...
          <motion.div
            ...
            className="lg:col-span-6 glass-panel-volcanic rounded-3xl p-8 sm:p-10 border border-[#4CE0FF]/40 relative overflow-hidden flex flex-col justify-between group hover:border-[#4CE0FF] transition-all duration-300 shadow-[0_0_40px_rgba(76,224,255,0.15)] hover:shadow-[0_15px_45px_rgba(76,224,255,0.25)] h-full"
          >
            ...
            <div>
              ...
              <div className="w-14 h-14 rounded-2xl bg-[#0A0A12] border border-[#4CE0FF]/40 flex items-center justify-center text-[#4CE0FF] mb-6 group-hover:scale-110 group-hover:rotate-3 transition-transform shadow-lg">
              ...
              <div className="mt-8 pt-6 border-t border-white/10">
                ...
                <div className="flex flex-wrap gap-2.5">
                  {certs[0].skills.map((s) => (
                    <span key={s} className="text-xs font-mono px-3.5 py-1.5 rounded-xl bg-[#0A0A12] text-[#4CE0FF] border border-[#4CE0FF]/30 font-semibold flex items-center gap-1.5">
            ...
            <div className="mt-8 pt-6 border-t border-white/10 flex items-center justify-between">
              <span className="text-xs font-mono text-zinc-300 font-semibold">Official Credential</span>
              <span className="text-xs font-mono text-[#4CE0FF] bg-[#4CE0FF]/10 px-3 py-1 rounded-md border border-[#4CE0FF]/30 font-bold flex items-center gap-1">
          ...
          <div className="lg:col-span-6 flex flex-col justify-between gap-6">
            {certs.slice(1).map((cert, idx) => (
              <motion.div
                ...
                className="glass-panel rounded-3xl p-6 sm:p-7 border border-white/10 hover:border-[#7F5CFF] transition-all duration-300 flex flex-col justify-between group hover:shadow-[0_10px_30px_rgba(127,92,255,0.2)] flex-1"
              >
                <div>
                  ...
                  <h4 className="text-lg sm:text-xl font-bold text-white font-display group-hover:text-[#7F5CFF] transition-colors">
                    {cert.title}
                  </h4>

                  <div className="flex flex-wrap gap-2 mt-3">
                    {cert.skills.map((s) => (
                      <span key={s} className="text-xs font-mono px-3 py-1 rounded-lg bg-white/5 text-zinc-300 border border-white/10 font-medium">
                        {s}
                      </span>
                    ))}
                  </div>
